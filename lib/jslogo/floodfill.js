...
export function floodFill(x, y) {
    var context = this, canvas = context.canvas, w = canvas.width, h = canvas.height;
    x = x | 0;
    y = y | 0;
    ...
    if (seedARGB === fillARGB)
        return;
    var sa = (seedARGB >> 24) & 0xff, sr = (seedARGB >> 16) & 0xff, sg = (seedARGB >> 8) & 0xff, sb = (seedARGB) & 0xff;
    var fa = (fillARGB >> 24) & 0xff, fr = (fillARGB >> 16) & 0xff, fg = (fillARGB >> 8) & 0xff, fb = (fillARGB) & 0xff;
