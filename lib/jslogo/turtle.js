...
Object.defineProperties(CanvasTurtle.prototype, {
    ...
    _moveto: { value: function (x, y, setpos) {
            ...
            var left = -w / 2, right = w / 2, bottom = -h / 2, top = h / 2;
    ...
    fill: { value: function () {
            this.canvas_ctx.save();
            this.canvas_ctx.setTransform(1, 0, 0, 1, 0, 0);
            this.canvas_ctx.floodFill(this.x * this.sx + this.width / 2, -this.y * this.sy + this.height / 2);
            this.canvas_ctx.restore();
        } },
    ...
    currentturtle: {
        ...
        set: function (newturtle) {
            if (newturtle === this._currentturtle)
                return;
